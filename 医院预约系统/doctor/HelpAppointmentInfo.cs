...
namespace Hospital
{
    public partial class HelpAppointmentInfo : FormBase
    {
        string pname, pid, did, dname, paccount, rid;
        DateTime time;

        public HelpAppointmentInfo(string pname, string pid, string did, string dname, string paccount, DateTime time, string ampm, string rid)//nid为预约号
        {
            InitializeComponent();
            string str = "";
